...
<head>
    ...
    <!-- Menu CSS -->
    <link href="${pageContext.request.contextPath}/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.css"
          rel="stylesheet">
    <!-- animation CSS -->
            ...
            <div class="top-left-part">
                <a class="logo" href="">
                    ...
                    <span class="hidden-xs">
                                <img src="${pageContext.request.contextPath}/plugins/images/pixeladmin-text.png"
                                     alt="home"/>
                            </span>
                </a>
            </div>
                ...
                <li>
                    <div class="dropdown">
                        <a class="profile-pic dropdown-toggle" data-toggle="dropdown" href="#">
                            <img src="${pageContext.request.contextPath}/plugins/images/users/varun.jpg" alt="user-img"
