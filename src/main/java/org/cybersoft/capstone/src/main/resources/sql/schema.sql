...
VALUES ('VIEW', 'View statistic', 'VIEW_STATISTIC', '/', 'GET', '1', NULL, 1),
       ...
       ('DELETE', 'Delete member', 'DELETE_MEMBER_PROJECT', '/user/*', 'DELETE', '0', NULL, 1),
       ...
       ('DELETE', 'Delete member', 'DELETE_MEMBER', '/user/*', 'DELETE', '0', NULL, 3),
       ('DELETE', 'Delete member', 'DELETE_MEMBER_PROJECT', '/user/*', 'DELETE', '1', NULL, 3),
       ...
       ('DELETE', 'Delete member', 'DELETE_MEMBER_PROJECT', '/user/*', 'DELETE', '0', NULL, 2),
