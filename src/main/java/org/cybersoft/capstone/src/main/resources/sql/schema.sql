...
VALUES ('VIEW', 'View statistic', 'VIEW_STATISTIC', '/', 'GET', '1', NULL, 1),
       ...
       ('VIEW', 'View statistic', 'VIEW_STATISTIC', '/', 'GET', '0', NULL, 3),
       ('VIEW', 'View create member', 'VIEW_CREATE_MEMBER', '/user-add', 'GET', '0', NULL, 3),
       ('CREATE', 'Create member', 'CREATE_MEMBER', '/user-add', 'POST', '1', NULL, 3),
       ...
       ('VIEW', 'View members', 'VIEW_MEMBERS', '/user-table', 'GET', '1', NULL, 3),
       ...
       ('VIEW', 'View statistic', 'VIEW_STATISTIC', '/', 'GET', '0', NULL, 2),
